...
public class BoardCreator : MonoBehaviour
{
    ...
    {
        Wall, Floor, Food, Enemy, InnerWall, Exit
    }
    ...
    public GameObject[] fillerWallsTiles;
    ...
    public static GameObject boardHolder;                           // GameObject that acts as a container for all other tiles.
    private int spawn = 0;
    ...
    public void Restart()
    {
        ...
        corridorLength = new IntRange(6, 10);
    ...
    public void InstantiateTiles()
    {
        ...
        for (int i = 0; i < columns; i++)
        {
            for (int y = 0; y < rows; y++)
            {
                InstantiateFromArray(floorTiles, i, y);

                  switch (tiles[i, y])
                  {
                      case TileType.Wall:
                          InstantiateFromArray(fillerWallsTiles, i, y);
                          break;
                      case TileType.Food:
                          InstantiateFromArray(foodTiles, i, y);
                          break;
                      case TileType.Enemy:
                          InstantiateFromArray(enemyTiles, i, y);
                          break;
                      case TileType.InnerWall:
                          InstantiateFromArray(wallTiles, i, y);
                          break;
                      case TileType.Exit:
                          InstantiateFromArray(exit, i, y);
                          break;
